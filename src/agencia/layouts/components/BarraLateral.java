 ...
 * @author felix
 */
public class BarraLateral extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BarraLateral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
